...
**Overview**
ArtCo is a Peer to Peer structured website built using
- Ruby on Rails
- HTML/CSS/Javascript
- PostrGreSQL database

**Project purpose**
Artco's purpose is to connect artists and venue owners together so that:
...
**Features**
- User specific log in functionality, using **Revise (Rails)**
- Database management using ActiveRecord
- Javascript via Stimulus JS
